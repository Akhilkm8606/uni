...
function Orders() {
    ...
    const fetchOrders = async () => {
      try {
        if (user?.role === 'seller') {
          ...
          toast.error('Unauthorized: You are not a seller');
        }
      } catch (error) {
  ...
  useEffect(() => {
    // Example: Check user's preference or system preference for dark mode
    // Here, we are toggling dark mode based on a state.
    // You can replace this with actual logic to determine dark mode.
